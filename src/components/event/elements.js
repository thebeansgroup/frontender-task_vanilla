  ...
  renderProgress() {
    ...
    return `
      <div class="event__progress">
        ...
        <div class="event__progress_meter"><div class="event__progress_meter_process" style="width: ${percentage}%"></div></div>
      </div>
    `;
  }
    ...
    return `
      <div class="event__funding">
        <p class="event__funding__totals">
          <span class="event__funding__raised">£${
            this.funding.raised / 100
          } raised</span>
